...
CREATE TABLE MEDICO (
    matricula          NUMBER(10)   GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE SECTOR (
    id_sector   NUMBER(10)    GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    descripcion VARCHAR2(100) NOT NULL
);

-- Habitacion(nro_habitacion, piso, orientacion, *id_sector*)
CREATE TABLE HABITACION (
    nro_habitacion NUMBER(10)   GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE ESPECIALIDAD (
    cod_especialidad NUMBER(10)    GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    descripcion      VARCHAR2(100) NOT NULL,
    id_sector        NUMBER(10)    NOT NULL
);
...
CREATE TABLE TURNO (
    id_turno NUMBER(10)   GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE INTERNACION (
    nro_internacion NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE RECORRIDO (
    id_recorrido    NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE GUARDIA (
    nro_guardia      NUMBER(10) GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
