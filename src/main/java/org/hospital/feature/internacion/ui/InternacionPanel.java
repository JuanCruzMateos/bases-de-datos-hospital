...
public class InternacionPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        // Nro Internacion (auto-generated, read-only)
        gbc.gridx = 0; gbc.gridy = 0;
        panel.add(new JLabel("Nro Internación (Auto):"), gbc);
        gbc.gridx = 1;
        txtNroInternacion = new JTextField(10);
        txtNroInternacion.setEditable(false);
        txtNroInternacion.setBackground(new Color(240, 240, 240));
        txtNroInternacion.setToolTipText("Auto-generated by database");
