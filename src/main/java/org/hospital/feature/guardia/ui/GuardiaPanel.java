package org.hospital.feature.guardia.ui;
...
public class GuardiaPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        // Nro Guardia (auto-generated, read-only)
        gbc.gridx = 0; gbc.gridy = 0;
        panel.add(new JLabel("Nro Guardia (Auto):"), gbc);
        gbc.gridx = 1;
        txtNroGuardia = new JTextField(10);
        txtNroGuardia.setEditable(false);
        txtNroGuardia.setBackground(new Color(240, 240, 240));
        txtNroGuardia.setToolTipText("Auto-generated by database");
