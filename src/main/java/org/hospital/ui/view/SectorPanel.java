...
public class SectorPanel extends JPanel {
    ...
    private JPanel createFormPanel() {
        ...
        // ID Sector (auto-generated, read-only)
        gbc.gridx = 0; gbc.gridy = 0;
        panel.add(new JLabel("ID Sector (Auto):"), gbc);
        gbc.gridx = 1;
        txtIdSector = new JTextField(10);
        txtIdSector.setEditable(false);
        txtIdSector.setBackground(new Color(240, 240, 240));
        txtIdSector.setToolTipText("Auto-generated by database");
